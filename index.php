...
<html prefix="og: http://ogp.me/ns#" style=""
   ...
   <head>
      ...
      <style >
         ...
         .bottom_controls #portfolio-nav ul:first-child li#all-items a:hover i {
         box-shadow: -.6em 0 #ffffff, -.6em .6em #ffffff, .6em 0 #ffffff, .6em -.6em #ffffff, 0 -.6em #ffffff, -.6em -.6em #ffffff, 0 .6em #ffffff, .6em .6em #ffffff;
         }
         .tabbed>ul li a.active-tab,
      ...
      <style >
         ...
         body:not(.ascend)[data-slide-out-widget-area="true"] #header-outer[data-has-menu="false"][data-permanent-transparent="false"] header#top,
         body.ascend[data-slide-out-widget-area="true"] #header-outer[data-has-menu="false"][data-permanent-transparent="false"][data-full-width="false"] header#top {
         padding-bottom: 25px;
         }
         }
      ...
      <style >
         ...
         .wpb_column.instance-12:hover:before {
         background-color: #ffffff;
         opacity: 1;
         }
         ...
         .wpb_column.instance-13:hover:before {
         background-color: #ffffff;
         opacity: 1;
         }
         ...
         .wpb_column.instance-16:hover:before {
         background-color: #ffffff;
         opacity: 1;
         }
      </style>
      <style >
         ...
         .row-bg-wrap.instance-3:after {
         background: linear-gradient(to bottom, #ffffff 0%, rgba(255, 255, 255, 0.001) 75%);
         opacity: 1;
         }
         .row-bg-wrap.instance-3:after {
         background: linear-gradient(to bottom, #ffffff 0%, rgba(255, 255, 255, 0.001) 100%);
         opacity: 1;
         }
   ...
   <body
      ...
      data-footer-reveal="false" data-footer-reveal-shadow="none" data-cae="easeOutQuart" data-cad="1000"
      data-aie="zoom-out" data-ls="magnific" data-apte="center_mask_reveal" data-hhun="1" data-fancy-form-rcs="1"
      data-form-style="default" data-is="inherit" data-button-style="rounded" data-header-inherit-rc="false"
      data-header-search="false" data-animated-anchors="true" data-ajax-transitions="true" data-full-width-header="false"
      data-slide-out-widget-area="true" data-loading-animation="none" data-bg-header="true" data-ext-responsive="true"
      data-header-resize="0" data-header-color="light" data-smooth-scrolling="0" data-permanent-transparent="false"
      data-responsive="1">
      ...
      <div id="header-space" data-header-mobile-fixed="1" style="height: 176px;"></div>
      <div id="header-outer" data-has-menu="true" data-transparent-header="true" data-remove-border="true"
         class="transparent at-top" data-mobile-fixed="1" data-ptnm="false" data-lhe="animated_underline"
         data-user-set-bg="#ffffff" data-format="default" data-permanent-transparent="false" data-cart="false"
         data-transparency-option="1" data-shrink-num="6" data-full-width="false" data-using-secondary="1"
         data-using-logo="1" data-logo-height="80" data-m-logo-height="25" data-padding="25" data-header-resize="0"
         style="padding-top: 25px; transform: translateY(0px); top: 47px;">
         <header id="top">
               ...
               <div class="row">
                  <div class="col span_3">
                     ...
                     <img class="stnd default-logo" alt="Sotapatroi" src="index_files/logo-sotapatro-wjhite.png"
                        ...
                        class="starting-logo default-logo" alt="Sotapatroi"
                        src="index_files/logo-sotapatro-wjhite.png" style="height: 80px;"><img
                        class="retina-logo starting-logo" alt="Sotapatroi"
                        src="index_files/logo-sotapatro-wjhite.png" style="height: 80px;">
                     </a>
                  </div>
                  <!--/span_3-->
					...
					-->
                     <nav>
                        <ul class="buttons" data-user-set-ocm="off">
                           <li id="search-btn" style="padding-bottom: 28px; padding-top: 28px;">
                              <div><a href="#searchbox"><span class="icon-salient-search"
                                 aria-hidden="true"></span></a></div>
                           </li>
                           <li class="slide-out-widget-area-toggle"
                              style="padding-bottom: 28px; padding-top: 28px;">
                              <div> <a href="#sidewidgetarea" class="closed"> <span> <i class="lines-button x2">
                                 <i class="lines"></i> </i> </span> </a> 
                              </div>
                           </li>
                        </ul>
                        <ul class="sf-menu sf-js-enabled sf-arrows">
                           <li id="menu-item-6284"
                              class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6284"><a
                              href="#produktua" style="padding-bottom: 54px; padding-top: 29px;">Produktua</a>
						   </li>
<!--
                           <li id="menu-item-6285"
                              class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6285"><a
                              href="#lantaldea"
							  style="padding-bottom: 54px; padding-top: 29px;">Lan-taldea</a></li>
-->							  
                           <li id="menu-item-6286"
                              class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6286"><a
                              href="#kontaktua" style="padding-bottom: 54px; padding-top: 29px;">Kontaktua</a>
                           </li>
                        </ul>
                     </nav>
                  </div>
      ...
      <!--/header-outer-->
      <div id="search-outer" class="nectar" style="top: 161px;">
         <div id="search">
      ...
      <div id="ajax-content-wrap" class="at-content">
         <div class="container-wrap" style="padding-top: 0px; padding-bottom: 0px; opacity: 1;">
            <div class="container main-content">
               <div class="row">
                  <div id="fws_5b2ad55f77eb0" data-midnight="light" data-bg-mobile-hidden=""
                     class="wpb_row vc_row-fluid vc_row full-width-content  vc_row-o-equal-height vc_row-flex parallax_section    first-section loaded"
                     style="padding-top: 189.56px; padding-bottom: 162.48px; margin-left: -90px; width: 1362px; visibility: visible;"
                     data-top-percent="14%" data-bottom-percent="12%">
                     <div class="row-bg-wrap instance-0">
                        <div class="row-bg using-image   translate" data-parallax-speed="medium"
                           style="background-image: url('index_files/bak-home-custom.jpg'); background-position: center top; background-repeat: no-repeat; height: 837px; transform: translate3d(0px, 136px, 0px) scale(1.005);"
                     ...
                     <div class="col span_12 light left">
                        <div class="vc_col-sm-12 wpb_column column_container col centered-text padding-3-percent instance-0 no-left-margin"
                           data-bg-cover="" data-padding-pos="left-right" data-has-bg-color="false"
                           data-bg-color="" data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1"
                           data-animation="" data-delay="0">
                           <div class="wpb_wrapper">
                              <div id="fws_5b2ad55f7920b" data-midnight="" data-bg-mobile-hidden=""
                                 class="wpb_row vc_row-fluid vc_row standard_section   "
                                 style="padding-top: 0px; padding-bottom: 30px; ">
                                 <div class="row-bg-wrap">
                                    <div class="row-bg   " style="height: 837px;"></div>
                                 </div>
                                 <div class="col span_12  ">
                                    <div class="vc_col-sm-6 wpb_column column_container col padding-1-percent has-animation instance-1 animated-in no-left-margin"
                                       data-padding-pos="bottom" data-has-bg-color="false" data-bg-color=""
                                       data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1"
                                       data-animation="fade-in-from-bottom" data-delay="200"
                                       style="opacity: 1; transform: translate(0px);">
                                       <div class="wpb_wrapper">
                                       </div>
                                    </div>
                                    <div class="vc_col-sm-6 wpb_column column_container col padding-7-percent has-animation instance-2 animated-in"
                                       data-padding-pos="right" data-has-bg-color="false" data-bg-color=""
                                       data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1"
                                       data-animation="fade-in-from-bottom" data-delay="300"
                                       style="opacity: 1; transform: translate(0px); top: -15px">
                                       <div class="wpb_wrapper">
                                          <div
                                             class="wpb_text_column wpb_content_element  vc_custom_1470012819227">
                                             <div class="wpb_wrapper">
...
-->										  
                              ...
                              <div id="fws_5b2ad55f7aa1a" data-midnight="" data-bg-mobile-hidden=""
                                 class="wpb_row vc_row-fluid vc_row standard_section   "
                                 ...
                                 <div class="col span_12  ">
                                    <div class="vc_col-sm-6 wpb_column column_container col no-extra-padding has-animation instance-3 no-left-margin"
                                       data-padding-pos="all" data-has-bg-color="false" data-bg-color=""
                                       data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1"
                                       data-animation="fade-in-from-bottom" data-delay="400">
                                       <div class="wpb_wrapper">
                                       </div>
                                    </div>
                                    <div class="vc_col-sm-6 wpb_column column_container col no-extra-padding instance-4"
                                       data-padding-pos="all" data-has-bg-color="false" data-bg-color=""
                                       data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1"
                                       data-animation="" data-delay="0">
                                       <div class="wpb_wrapper">
                  ...
                  <div id="produktua" data-midnight="dark" data-bg-mobile-hidden=""
                     class="wpb_row vc_row-fluid vc_row full-width-section standard_section   "
                     style="padding: 20px 90px 67.7px; margin-left: -90px; visibility: visible;"
                     data-bottom-percent="5%">
                     <div class="row-bg-wrap instance-1">
                        <div class="row-bg  using-bg-color " style="background-color: #f5f5f5; "
                           data-color_overlay="" data-color_overlay_2="" data-gradient_direction=""
                           data-overlay_strength="0.3" data-enable_gradient="false"></div>
                     </div>
                     <div class="col span_12 dark left">
                        <div class="vc_col-sm-12 wpb_column column_container col no-extra-padding instance-5 no-left-margin"
                           ...
                           <div class="wpb_wrapper">
                              <div class="wpb_content_element" data-interval="0">
                                 <div class="wpb_wrapper tabbed clearfix" data-style="minimal"
                                    data-alignment="left">
                                    <ul class="wpb_tabs_nav ui-tabs-nav clearfix">
                                       <li><a href="#tab-sotapatroi" class="active-tab">Sotapatroi</a></li>
                                       <li><a href="#tab-funtzionamendua">Funtzionamendua</a></li>
                                    </ul>
                                    <div id="tab-sotapatroi"
                                       class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide clearfix"
                                       style="visibility: visible; position: relative; opacity: 1; left: 0px; display: block;">
                                       <div id="fws_5b2ad55f7ca1d" data-midnight="" data-bg-mobile-hidden=""
                                          class="wpb_row vc_row-fluid vc_row standard_section   "
                                          style="padding-top: 0px; padding-bottom: 0px; ">
                                          <div class="row-bg-wrap">
                                          ...
                                          <div class="col span_12  ">
                                             <div class="vc_col-sm-3 vc_col-lg-3 vc_col-md-4 wpb_column column_container col padding-4-percent has-animation instance-6"
                                                   ...
                                                   <div class="wpb_text_column wpb_content_element ">
                                                      <div class="wpb_wrapper">
                                                         <p style="text-align: right;">
                                                            <strong>Sotapatroi</strong> aisialdirako
                                                            itsasontzietan segurtasuna hobetzen dauan
                                                            sistemea da, patroia uretara jausi ezkero
                                                            ontzia geldiaraziz.
                                                         </p>
                                                      </div>
                                                   </div>
                                             ...
                                             <div class="vc_col-sm-6 vc_col-lg-6 vc_col-md-8 wpb_column column_container col padding-4-percent instance-7"
                                                data-padding-pos="bottom" data-has-bg-color="false"
                                                data-bg-color="" data-bg-opacity="1" data-hover-bg=""
                                                data-hover-bg-opacity="1" data-animation="" data-delay="0">
                                                <div class="wpb_wrapper">
                                                   <div class="img-with-aniamtion-wrap center"><img
                                             ...
                                             <div class="vc_col-sm-3 vc_col-lg-offset-0 vc_col-lg-3 vc_col-md-offset-4 vc_col-md-8 wpb_column column_container col padding-4-percent has-animation instance-8"
                                                ...
                                                data-bg-color="" data-bg-opacity="1" data-hover-bg=""
                                                data-hover-bg-opacity="1" data-animation="fade-in-from-left"
                                                data-delay="0">
                                                <div class="wpb_wrapper">
                                                   <div
                                                      class="wpb_text_column wpb_content_element  vc_custom_1476356263030">
                                                      <div class="wpb_wrapper">
                                                         <p><strong>Arduino</strong> eta
                                                            <strong>iBeacon</strong> teknologi
                                                            askeetan oinarrituta eta ontziko VHF
                                                            irratira konektatuta, patroia
                                                            ontzira denpora jakin baten bueltatu ezean,
                                                            sistemak larrialdi abisua
                                                            bihaltzen dau Itsas Salbamendura eta
                                                            inguruko ontzi guztietara.
                                                         </p>
                                                      </div>
                                                   </div>
                                                </div>
                                    ...
                                    <div id="tab-funtzionamendua"
                                       class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide clearfix"
                                       style="visibility: hidden; position: absolute; opacity: 0; left: -9999px; display: none;">
                                       <div id="fws_5b2ad55f7df68" data-midnight="" data-bg-mobile-hidden=""
                                          class="wpb_row vc_row-fluid vc_row standard_section   "
                                          style="padding-top: 0px; padding-bottom: 0px; ">
                                          <div class="row-bg-wrap">
                                          ...
                                          <div class="col span_12">
                                             <div class="vc_col-sm-6 wpb_column column_container col no-extra-padding instance-9 no-left-margin"
                                             ...
                                             <div class="vc_col-sm-3 wpb_column column_container col no-extra-padding instance-10 one-fourths clear-both no-left-margin"
                                                ...
                                                <div class="wpb_wrapper">
                                                   <div class="wpb_text_column wpb_content_element ">
                                                      <div class="wpb_wrapper">
                                                         <p>
															<strong>1.</strong> <strong>Sotapatroi
                                                            ®</strong> itsasontzian&nbsp;instalatzen
															da.<br><br>
															
                                                            <strong>2.</strong> Itsasora urten
                                                            aurretik,&nbsp;<strong>Sotapatroi</strong>a
                                                            piztu eta&nbsp;eskumuturrekoa jartzen
															da,&nbsp;segurtasun sistemea aktibatuz.<br><br>
															
                                                            <strong>3.</strong> Nabigatzerakoan
                                                            itsasontziak&nbsp;edo patroiak
                                                            ezbeharren bat&nbsp;euki eta patroia uretara
                                                            jausi&nbsp;ezkero edo
                                                            patroia itsasontzitik&nbsp;urrundu ezkero,
                                                            <strong>Sotapatroi ®&nbsp;</strong>martxan
															jarriko da.<br><br>
                                                         </p>
                                                      </div>
                                                   </div>
                                             ...
                                             <div class="vc_col-sm-3 wpb_column column_container col no-extra-padding instance-11 one-fourths right-edge no-left-margin"
                                                data-padding-pos="all" data-has-bg-color="false"
                                                data-bg-color="" data-bg-opacity="1" data-hover-bg=""
                                                data-hover-bg-opacity="1" data-animation="" data-delay="0">
                                                <div class="wpb_wrapper">
                                                   <div class="wpb_text_column wpb_content_element ">
                                                      <div class="wpb_wrapper">
                                                         <p>
                                                            <strong>4.</strong> Patroiak soinean
                                                            daroan&nbsp;eskumuturrekoak
                                                            itsasontziko&nbsp;seinale-hargailuagaz&nbsp;konekzinoa
                                                            galtzeagaz
                                                            batera&nbsp;itsasontzia
															automatikoki&nbsp;geldituko da.															 
															<br><br>
															<strong>4-A.</strong> Patroia
                                                            itsasontzira&nbsp;bueltatu ezkero,
                                                            <strong>Sotapatroi
                                                            ®</strong>&nbsp;berraktibatu eta
                                                            normaltasunez&nbsp;nabigatzen jarrai
                                                            daike.<br><br>
                                                            <strong>4-B.</strong> Marinela ontzira
                                                            denpora&nbsp;jakin baten bueltatu
                                                            ezean,&nbsp;<strong>Sotapatroi</strong>ak
                                                            larrialdi abisua&nbsp;bialduko dau Itsas
                                                            Salbamendura&nbsp;eta inguruan
                                                            nabigatzen&nbsp;dagozan ontzietara.
                                                         </p>
                                                      </div>
                                                   </div>
                                                </div>
				  ...
				  <div id="kontaktua" data-midnight="light" data-bg-mobile-hidden="" class="wpb_row vc_row-fluid vc_row full-width-content standard_section   " style="padding-top: 0px; padding-bottom: 0px; margin-left: -90px; width: 1362px; visibility: visible;"><div class="row-bg-wrap instance-4"> <div class="row-bg   " style="" data-color_overlay="#585b64" data-color_overlay_2="#2c2f38" data-gradient_direction="left_to_right" data-overlay_strength="1" data-enable_gradient="true"></div> </div><div class="col span_12 light left">
					<div style="margin-top: 20px; height: 674px;" class="vc_col-sm-6 wpb_column column_container col centered-text padding-4-percent instance-17 no-left-margin" data-bg-cover="" data-padding-pos="top-left" data-has-bg-color="false" data-bg-color="" data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1" data-animation="" data-delay="0">
							<div class="wpb_wrapper">
								
					<div class="wpb_text_column wpb_content_element  vc_custom_1470014474639">
						<div class="wpb_wrapper">
							<h4 class="vc_custom_heading" style="text-align: left;">Garrantzitsuena segurtasunez nabigatzea da</h4>
				
						</div>
					</div>
				
					<div class="wpb_text_column wpb_content_element  vc_custom_1470014643419">
						<div class="wpb_wrapper">
				...
				<div class="img-with-aniamtion-wrap center"><img class="img-with-animation  animated-in" data-delay="0" data-animation="fade-in" src="http://sotapatroi.eus/index_files/eskuak2.png" alt="" style="opacity: 1; width: 100%"></div>
					...
					<div class="vc_col-sm-6 wpb_column column_container col padding-5-percent instance-18" data-bg-cover="" data-padding-pos="all" data-has-bg-color="false" data-bg-color="" data-bg-opacity="1" data-hover-bg="" data-hover-bg-opacity="1" data-animation="" data-delay="0" style="height: 674px;">
							<div class="wpb_wrapper">
								<div role="form" class="wpcf7" id="wpcf7-f6224-p236-o1" dir="ltr" lang="eu">
            ...
            <div class="off-canvas-menu-container mobile-only">
               <div class="menu-wrap menuwrapper">
                  <ul class="menu menuopen">
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6284"><a
                        href="#produktua">Produktua</a></li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6285"><a
                        href="#lantaldea">Lan-taldea</a></li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-6286"><a
                        href="#kontaktua">Kontaktua</a></li>
                  </ul>
               </div>
            </div>
         </div>
      ...
      <div id="wp-a11y-speak-assertive" role="alert" aria-live="assertive" aria-relevant="additions text"
         aria-atomic="true" class="screen-reader-text wp-a11y-speak-region"></div>
   </body>
</html>